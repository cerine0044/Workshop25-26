...
void main() async {
  print('🧪 Test de Bout en Bout Complet - Pandora Box');
  print('=============================================');
  ...
  // Test 2: Démarrer le serveur WebSocket
  print('🚀 Test 2: Démarrage du serveur WebSocket');
  ...
  print('🔌 Test 3: Connexion WebSocket');
  await _testWebSocketConnection(localIP);
  print('');
  
  // Test 4: Test de création de room
  print('🏠 Test 4: Création de room');
  await _testRoomCreation(localIP);
  print('');
  
  // Test 5: Test de connexion multiple
  print('👥 Test 5: Connexions multiples');
  await _testMultipleConnections(localIP);
  print('');
  ...
  print('4. Exécutez: dart run test_client.dart');
...
Future<void> _testWebSocketConnection(String localIP) async {
  try {
...
Future<void> _testRoomCreation(String localIP) async {
  try {
    final channel = WebSocketChannel.connect(Uri.parse('ws://$localIP:5002'));
...
Future<void> _testMultipleConnections(String localIP) async {
  try {
    ...
    print('❌ Erreur connexions multiples: $e');
  }
}

...
/// Script de gestion Firebase depuis le terminal
/// Usage: dart firebase_cli.dart [command] [options]
    ...
    switch (command) {
      ...
      case 'restore':
        if (arguments.length < 2) {
          print('❌ Usage: dart firebase_cli.dart restore <filename>');
          return;
        }
...
void _showHelp() {
  print('''
🔥 Firebase CLI - Gestionnaire de base de données
